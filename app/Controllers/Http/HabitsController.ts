 ...
 *     tags:
 *       - Habitos
 *     summary: Lista de los habitos del sistema
 *     security:
 *       - bearerAuth: []
 *     produces:
 *       - application/json
...
public async index({response}: HttpContextContract) {
   ...
   *     tags:
   *       - Habitos
   *     summary: Crear un nuevo recurso de habito 
   *     security:
   *       - bearerAuth: []
   *     produces:
   *       - application/json
   ...
   *     security:
   *       - bearerAuth: []
   *     summary: Mostrar el habito especifico por identificador
   *     produces:
   *       - application/json
   *     parameters:
   *       - in: path
   ...
   *     tags:
   *       - Habitos
   *     summary: Actualizar habito especifico por identificador
   *     security:
   *       - bearerAuth: []
   *     produces:
   *       - application/json
   ...
   *     tags:
   *       - Habitos
   *     summary: Eliminar habito especifico por identificador
   *     security:
   *       - bearerAuth: []
   *     produces:
   *       - application/json
