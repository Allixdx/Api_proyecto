    ...
    public async index({request}: HttpContextContract) {
      ...
      public async show({params,response}: HttpContextContract) {
        ...
        */
        const configuration = await Configuration.query()
          .where('configuration_id',params.configuration_id)
          .preload('habit',(habit)=>{
            habit.preload('user')    
            })
          .first()
      ...
      public async update({params,request,response}: HttpContextContract) {
        ...
        */
        ...
        var configuration = await Configuration.find(params.configuration_id)
        if(!configuration){
            response.notFound({                 
                "type":"Error",
                "title": "Recurso no encontrado",
      ...
      public async destroy({params,response}: HttpContextContract) {
        ...
        * 
        */
        const configuration = await Configuration.query().where('configuration_id',params.configuration_id).first()
